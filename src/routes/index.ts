...
import approvalRoute from "../modules/admin/order/approval/approvalRoute";
...
import alertRoute from "../modules/admin/alert/alertRoutes";
import orderRoute from "../modules/admin/order/orderRoute"
